...
//	ldyw_group.imr_multiaddr.S_un.S_addr = inet_addr(group_ip);
//	ldyw_group.imr_interface.S_un.S_addr = htonl(INADDR_ANY);
//
//	setsockopt(s, IPPROTO_IP, IP_ADD_MEMBERSHIP, &ldyw_group, sizeof(ldyw_group));
//}
