...
// 高层持久化辅助逻辑：
// - 确认 /www/cgi-bin/test.db 存在且 quick_check 通过
// - 先复制到 .tmp，旋转旧 .bak，再通过 rename 原子替换
...
//			printf("get rate=%d  \r\n",mparam->mgmt_virt_unicast_mcs);
		...
		if(0 == strcmp(argv[0],"workmode"))
		{
			...
			//g_radio_param.g_workmode=workmode;
...
// add  by sdg 20250625
		if(0 == strcmp(argv[0],"m_route"))
		{
			...
			//g_radio_param.g_route=meshinfo.m_route;
		...
		if(0 == strcmp(argv[0],"m_slot_len"))
		{
			...
			//g_radio_param.g_slot_len=meshinfo.m_slot_len;
		...
		if(0 == strcmp(argv[0],"m_trans_mode"))
		{
			...
			//g_radio_param.g_trans_mode=meshinfo.m_trans_mode;
		...
		if(0 == strcmp(argv[0],"m_select_freq2"))
		{
			...
			//g_radio_param.g_select_freq_2=meshinfo.m_select_freq_2;
			meshinfo.select_freq_isset=1;
		...
		if(0 == strcmp(argv[0],"m_select_freq3"))
		{
			...
			//g_radio_param.g_select_freq_3=meshinfo.m_select_freq_3;
			meshinfo.select_freq_isset=1;
		...
		if(0 == strcmp(argv[0],"m_select_freq4"))
		{
			...
			//g_radio_param.g_select_freq_4=meshinfo.m_select_freq_4;
			meshinfo.select_freq_isset=1;
...
void updateData_systeminfo_qk(const char* name,const int value)
{
	...
	// sprintf(stsysteminfodata.name,"%s",name);
	// sprintf(stsysteminfodata.value,"%d",value);
    // stsysteminfodata.state[0] = '1';
	// updateData_systeminfo(stsysteminfodata);
